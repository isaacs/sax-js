...
T.DOCTYPE_QUOTED = function (parser, c) {
  parser.doctype += c;
  if (c === parser.q) {
    parser.q = "";
    parser.state = S.DOCTYPE;
...
T.DOCTYPE_DTD = function (parser, c) {
  parser.doctype += c;
...
T.DOCTYPE_DTD_QUOTED = function (parser, c) {
  parser.doctype += c;
  if (c === parser.q) {
