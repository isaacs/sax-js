...
function SAXParser (strict, opt) {
  ...
  parser.attribNameCase = parser.opt.lowercaseattribname ? "toLowerCase" : "toUpperCase"
  parser.tags = []
...
function attrib (parser) {
  if (!parser.strict) parser.attribName = parser.attribName[parser.attribNameCase]
  if (parser.opt.xmlns) {
